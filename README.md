...
```sh
git clone git@github.com:yicunstar/my_first_chisel_repository.git
cd my_first_chisel_repository
```
...
#### Commit your changes
```sh
git commit -m 'Starting my_first_chisel_repository'
...
```sh
./mill my_first_chisel_repository.test
```
